...
exports.Client = function (options){
    ...
    // connection manager
    connectManager = new ConnectManager(this, parserManager, serializerManager),
...
var ConnectManager = function(client, parserManager, serializerManager) {
    ...
    this.handleResponse = function(res,data,callback){
		...
		// found
        parserManager.get(res).parse(data, client.emit, function(parsedData){
    ...
    this.proxy = function(options, callback){
        ...
        debug("proxy options",options.proxy);
            ...
            proxyTunnel.on('connect',function(res, socket, head){
               ...
               if(options.data){
                    serializerManager.get(options).serialize(options.data, clientEmitterWrapper(client), function(serializedData){
